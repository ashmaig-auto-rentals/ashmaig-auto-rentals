    ...
    <main>
      ...
      <section className="section max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-gray-700">
          ...
          <div>
            <h3 className="font-medium text-lg mb-2">2. Insurance</h3>
            <p>
              Proof of active <span className="font-semibold">full coverage insurance</span> is required.
              If you only carry liability, you may upgrade to full coverage through us or book securely via Turo.
            </p>
          </div>

          <div>
            <h3 className="font-medium text-lg mb-2">3. Payment</h3>
            <p>
              Full payment is due at the time of booking. We accept all major credit and debit cards via our secure
              checkout system. No security deposits are required.
            </p>
          </div>

          <div>
            <h3 className="font-medium text-lg mb-2">4. Vehicle Condition</h3>
            <p>
              Vehicles are provided clean, fueled, and inspected. Renters are responsible for returning the vehicle
              in the same condition. Smoking and pets are not permitted inside vehicles.
            </p>
          </div>
          ...
          <div>
            <h3 className="font-medium text-lg mb-2">7. Liability</h3>
            <p>
              Ashmaig Auto Rentals is not responsible for lost or stolen items left in vehicles.
              Renters assume full responsibility for traffic violations, tolls, and accidents.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section bg-gray-50 text-center">
        ...
        <p className="text-gray-700 max-w-2xl mx-auto">
          By booking a vehicle with Ashmaig Auto Rentals, you agree to abide by the above rental agreement.
          A digital copy of this agreement will be provided via email upon booking confirmation.
        </p>
      </section>
    </main>
  );
