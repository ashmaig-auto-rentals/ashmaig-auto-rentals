...
export const metadata = {
  ...
  description:
    "Tempe AZ rideshare car rentals for Uber, Lyft, and delivery drivers. $300/week, insurance & maintenance included, unlimited miles, no deposit, same-day approval.",
  alternates: {
  ...
  openGraph: {
    title: "Tempe Uber & Lyft Car Rentals | Ashmaig Auto Rentals",
    description:
      "Rent a reliable rideshare car in Tempe for Uber, Lyft, and delivery. $300/week, unlimited miles, insurance & maintenance included.",
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Most Tempe rideshare rentals start at $300 per week. This includes insurance, basic maintenance, and unlimited mileage for Uber, Lyft, and delivery driving.",
        },
      },
      {
        "@type": "Question",
