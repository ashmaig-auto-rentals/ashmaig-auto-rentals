...
export const metadata = {
  title: "Tempe Uber & Lyft Car Rentals | Ashmaig Auto Rentals",
  description:
    "Tempe AZ rideshare car rentals for Uber, Lyft, and delivery drivers. $400/week, insurance & maintenance included, unlimited miles, no deposit, same-day approval.",
  alternates: {
    canonical: "https://ashmaig.com/locations/tempe",
  },
  openGraph: {
    title: "Tempe Uber & Lyft Car Rentals | Ashmaig Auto Rentals",
    description:
      "Rent a reliable rideshare car in Tempe for Uber, Lyft, and delivery. $400/week, unlimited miles, insurance & maintenance included.",
    url: "https://ashmaig.com/locations/tempe",
    type: "website",
    locale: "en_US",
  },
};
...
export default function TempePage() {
  const faqJsonLd = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Can I use your cars for Uber and Lyft in Tempe, AZ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. Our vehicles are specifically set up for Uber and Lyft rideshare use in Tempe and nearby areas like ASU campus, Mesa, and Chandler. We provide the documentation you need so you can get on the road quickly.",
        },
      },
      {
        "@type": "Question",
        name: "How much does a rideshare rental cost in Tempe?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Most Tempe rideshare rentals start at $400 per week. This includes insurance, basic maintenance, and unlimited mileage for Uber, Lyft, and delivery driving.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "How fast can I get a car for Uber or Lyft in Tempe?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Many Tempe drivers are approved and on the road with a rideshare rental the same day, depending on availability and completion of required insurance paperwork.",
        },
      },
    ],
  };
  ...
  const businessJsonLd = {
    "@context": "https://schema.org",
    "@type": "CarRental",
    name: "Ashmaig Auto Rentals - Tempe Uber & Lyft Car Rental",
    url: "https://ashmaig.com/locations/tempe",
    telephone: "+16237772376",
    priceRange: "$$",
    description:
      "Tempe AZ Uber & Lyft car rentals with unlimited miles, insurance included, and no deposit. Perfect for rideshare and delivery drivers in Tempe, ASU area, Mesa, and the East Valley.",
    address: {
      "@type": "PostalAddress",
  ...
  return (
    <main className="bg-white text-gray-900 dark:bg-slate-900 dark:text-gray-100">
      {/* JSON-LD Structured Data (Tempe CarRental + FAQ) */}
      <script
      ...
      <section
        ...
        id="tempe-uber-lyft-rentals"
      >
        <Image
          src="/desert-car.jpg"
          alt="Tempe AZ Uber and Lyft rideshare rental car background"
          fill
          ...
          <div className="w-full grid gap-10 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)] items-center">
            ...
            <div className="text-white max-w-3xl">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold leading-tight">
                Tempe Uber & Lyft Car Rentals for Rideshare & Delivery
              </h1>
              ...
              <p className="mt-3 text-lg md:text-xl text-gray-200 max-w-xl">
                Tempe rideshare rentals built for Uber, Lyft, and delivery
                drivers. Drive a clean, reliable car across Tempe, ASU campus,
              ...
              <div className="mt-4 flex flex-wrap gap-3 text-sm md:text-base text-gray-200">
                ...
                <span className="inline-flex items-center rounded-full bg-white/10 px-3 py-1">
                  ✅ Perfect for ASU students & East Valley commuters
                </span>
              </div>
            </div>
            ...
            <div className="w-full flex justify-center lg:justify-end">
              <div className="w-full max-w-md bg-white/95 dark:bg-slate-900/95 backdrop-blur-md rounded-2xl shadow-2xl border border-white/60 dark:border-slate-700 p-4 sm:p-5">
                <h2 className="text-lg font-semibold mb-2 text-gray-900 dark:text-gray-100 text-center sm:text-left">
                  Apply for a Tempe Rideshare Rental
                </h2>
                ...
                <p className="mt-3 text-xs text-gray-500">
                  Ideal for searches like “Uber car rental Tempe”, “Lyft car
                  rental near ASU”, and “Tempe rideshare rentals East Valley”.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-blue-600 text-white py-12 text-center">
        <h2 className="text-3xl font-bold">
          Start Earning with a Reliable Uber & Lyft Car in Tempe
        </h2>
        ...
        <p className="mt-3 text-sm text-blue-100 max-w-2xl mx-auto">
          Serving Tempe, ASU campus, Mesa, Chandler, and Phoenix for Uber, Lyft,
      ...
      <section className="section bg-gray-50 dark:bg-slate-800">
        <h2 className="text-2xl font-semibold text-center mb-4">
          Requirements to Rent a Rideshare Car in Tempe
        </h2>
        <p className="text-center text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-6 text-sm md:text-base">
          We make it easy for Tempe drivers to get on the road with Uber and
      ...
      <section className="section bg-gray-50 dark:bg-slate-800">
        <h2 className="text-2xl font-semibold text-center mb-6">
          Why Tempe Uber & Lyft Drivers Choose Ashmaig Auto Rentals
        </h2>
        <p className="text-center text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8 text-sm md:text-base">
          We understand what rideshare and delivery drivers in the Tempe and ASU
          area need: reliable cars, simple pricing, and fast approval. Our fleet
          is chosen with Uber, Lyft, Uber Eats, DoorDash, and Instacart in mind
          so you can maximize your hours around Mill Ave, ASU campus, and the
          East Valley.
        </p>
          ...
          {[
            {
              ...
              desc: "Many Tempe drivers are approved and driving within 24 hours.",
            },
            {
              icon: "🛡️",
            ...
            },
            {
              ...
              desc: "Drive as much as you need across Tempe & Phoenix.",
            },
            {
              icon: "💳",
      ...
      <section className="section bg-white dark:bg-slate-900">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl font-semibold text-center mb-2">
            Cars Available for Tempe Rideshare & Delivery Drivers
          </h2>
          <p className="text-center text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Fuel-efficient sedans ideal for Uber, Lyft, Uber Eats, DoorDash, and
            more in Tempe, ASU area, Mesa, and the East Valley.
          </p>
            ...
            {[
              ...
              >
                <div className="relative w-full h-40 md:h-48 mb-4">
                  <Image
                    src={img}
                    alt={`${name} rideshare rental car in Tempe AZ for Uber and Lyft`}
                    fill
        ...
        <div className="max-w-5xl mx-auto grid gap-10 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]">
          <div>
            <h2 className="text-2xl font-semibold mb-4">
              Tempe Uber & Lyft Car Rental Near ASU, Mesa & East Valley
            </h2>
            <p className="text-gray-700 dark:text-gray-200 text-sm md:text-base mb-3">
              ...
              reliable rideshare car is essential. Our Tempe car rentals are
              set up to meet Uber and Lyft requirements in Arizona, making it
              easy to start earning quickly.
            </p>
            <p className="text-gray-700 dark:text-gray-200 text-sm md:text-base mb-3">
              Many of our drivers live near Tempe, ASU main campus, Mesa, and
              Chandler, or commute into Phoenix and Scottsdale for busy hours.
            ...
            <div className="space-y-3 text-sm text-gray-700 dark:text-gray-200">
              <details className="bg-white dark:bg-slate-700 border border-gray-200 dark:border-gray-600 rounded-lg p-3">
                <summary className="font-medium cursor-pointer">
                  Can I use your cars for Uber and Lyft in Tempe?
                </summary>
                <p className="mt-2">
                  Yes. Our vehicles are set up for Uber and Lyft use in Tempe,
                  ASU campus, Mesa, and the East Valley. We&apos;ll help you
                  with the basic documentation you need.
                </p>
              </details>
              <details className="bg-white dark:bg-slate-700 border border-gray-200 dark:border-gray-600 rounded-lg p-3">
                <summary className="font-medium cursor-pointer">
