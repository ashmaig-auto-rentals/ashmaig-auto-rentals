...
export const metadata = {
  ...
  description:
    "Scottsdale rideshare car rentals for Uber, Lyft, and delivery drivers. $300/week, insurance & maintenance included, unlimited miles, no deposit, same-day approval.",
  alternates: {
  ...
  openGraph: {
    title: "Scottsdale Uber & Lyft Car Rentals | Ashmaig Auto Rentals",
    description:
      "Rent a reliable rideshare car in Scottsdale for Uber, Lyft, and delivery. $300/week, unlimited miles, insurance & maintenance included.",
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Most Scottsdale rideshare rentals start at $300 per week. This includes insurance, basic maintenance, and unlimited mileage for Uber, Lyft, and delivery driving.",
        },
      },
      {
        "@type": "Question",
